...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -118.0, 1219.0, 178.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -56.0, 1300.0, 138.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -144.0, 1218.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -144.0, 1244.0, 49.0, 16.0 ],
					"text" : "mode $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -240.0, 1267.0, 57.0, 18.0 ],
					"text" : "cv.jit.dilate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -249.0, 1263.0, 81.0, 25.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -240.0, 1320.0, 320.0, 240.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -247.0, 1297.0, 334.0, 268.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -156.0, 1209.0, 227.0, 65.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 495.0, 795.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 1315.0, 119.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 1154.0, 158.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 1282.0, 57.0, 18.0 ],
					"text" : "cv.jit.dilate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 135.0, 1335.0, 320.0, 240.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 221.0, 1154.0, 48.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 135.0, 1204.0, 243.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 1175.0, 64.0, 16.0 ],
					"text" : "threshold $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 1312.0, 334.0, 268.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 1278.0, 81.0, 25.0 ],
					"rounded" : 30
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 1144.0, 344.0, 87.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 195.0, 1074.0, 62.0, 18.0 ],
					"text" : "jit.rgb2luma"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 915.0, 1080.0, 66.0, 20.0 ],
					"text" : "cv.jit.dilate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 450.0, 1035.0, 132.0, 20.0 ],
					"text" : "cv.jit.resize @size 80 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 795.0, 765.0, 174.0, 20.0 ],
					"text" : "jit.matrix 4 char 80 1 @interp 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 810.0, 855.0, 181.0, 20.0 ],
					"text" : "jit.matrix 4 char 400 1 @interp 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 450.0, 1080.0, 119.0, 20.0 ],
					"text" : "jit.matrix 4 char 80 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 810.0, 795.0, 59.0, 20.0 ],
					"text" : "jit.brcosa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 420.0, 1185.0, 320.0, 240.0 ],
					"presentation_rect" : [ 447.0, 1105.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 450.0, 1110.0, 72.0, 20.0 ],
					"text" : "jit.op @op -"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 705.0, 735.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 795.0, 735.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 795.0, 690.0, 188.0, 20.0 ],
					"text" : "cv.jit.resize @size 80 1 @interp 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 480.0, 750.0, 139.0, 20.0 ],
					"text" : "jit.slide @slide_down 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 795.0, 645.0, 123.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 555.0, 48.0, 31.0 ],
					"presentation_rect" : [ 760.0, 559.0, 0.0, 0.0 ],
					"text" : "0.667781"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 675.0, 570.0, 50.0, 31.0 ],
					"text" : "-0.396187"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 675.0, 510.0, 59.5, 20.0 ],
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 795.0, 900.0, 320.0, 240.0 ],
					"presentation_rect" : [ 791.0, 732.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 435.0, 705.0, 126.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 120.0, 810.0, 320.0, 240.0 ],
					"presentation_rect" : [ 737.0, 559.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 435.0, 73.0, 20.0 ],
					"text" : "jit.unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 708.0, 238.0, 210.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 325.0, 272.0, 129.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 475.0, 233.0, 141.0, 68.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 238.0, 175.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 95.0, 240.0, 93.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.0, 666.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 660.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 870.0, 765.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 963.0, 780.0, 150.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -134.5, 1263.0, -230.5, 1263.0 ],
					"source" : [ "obj-105", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 230.5, 1197.0, 144.5, 1197.0 ],
					"source" : [ "obj-97", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				"name" : "cvtitle.png",
				"bootpath" : "/Users/research/Desktop/_Git/Synthesis/O4_ASU/ThirdParties/cv.jit_OSX_v1.7.2/cv.jit-support/Data",
				"patcherrelativepath" : "../../Synthesis/O4_ASU/ThirdParties/cv.jit_OSX_v1.7.2/cv.jit-support/Data",
				"type" : "PNG ",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "/Users/research/Desktop/_Git/Synthesis/O4_ASU/ThirdParties/cv.jit_OSX_v1.7.2/cv.jit Help",
				"patcherrelativepath" : "../../Synthesis/O4_ASU/ThirdParties/cv.jit_OSX_v1.7.2/cv.jit Help",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
